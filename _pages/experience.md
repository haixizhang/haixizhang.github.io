...
### ML Engineer
**Tensor Auto** | **Sep 2025 - Present**  
**Location:** San Jose, CA  

**Focus:** Multi-sensor data pipelines, applied ML for perception, and production deployment

**Highlights:**
- Built workflows for multi-sensor log processing (e.g., camera / LiDAR / CAN), including ETL, time alignment, and data validation for downstream training and evaluation
- Curated reproducible datasets and evaluation sets for model iteration and regression testing
...
**Key Contributions:**
- Developed graph learning and nature-inspired computing models using PyTorch and mathematical proofs
